			...
			<div className="lg:flex-row-reverse lg:justify-between lg:pb-20 pb-10 flex justify-center flex-col items-center ">
				...
				<div className="lg:pb-20">
					...
					<div className="lg:flex lg:flex-row-reverse lg:max-w-340">
						<button className="flex mb-4 text-textColor lg:mb-0 lg:w-30 items-center justify-center font-body text-14px font-bold border-textColor border-2 rounded-full w-full py-3">
							<img className="inline mr-2" src="/icon-github.svg" />
							VER CÓDIGO
						</button>
						<button className="bg-greenLight lg:mr-3 lg:w-30 font-body text-14px font-bold border-textColor border-2 rounded-full w-full py-3">
							VER PROYECTO
						</button>
					</div>
				</div>
